# StockWise Production Deployment Guide

This guide outlines the steps to deploy StockWise to Netlify for the frontend and Supabase for the backend.
...
2. **Apply Migrations**: 
   ...
   - Run the files sequentially (e.g. `20260513182000_stockwise_schema.sql`, `0002_*.sql`, etc.) to generate the required schema.
...
3. **Configure Authentication**:
   ...
   - In Authentication -> URL Configuration, set your **Site URL** to your custom domain or Netlify URL (e.g., `https://stockwise.app`).
...
1. **Push Code to GitHub**: Ensure all StockWise code is committed and pushed to a GitHub repository.
...
3. Enter your domain (e.g., `stockwise.co.zw`).
