              ...
              {isForgotPassword ? (
                ...
                <>
                  ...
                  <Button 
                    type="button" 
                    variant="outline" 
                    className="w-full h-11 font-semibold text-xs flex items-center justify-center space-x-2 border-zinc-200 hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-800 bg-white"
